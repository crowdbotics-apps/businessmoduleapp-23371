"""businessmoduleapp_23371 URL Configuration
...
admin.site.site_title = "BusinessModuleApp Admin Portal"
admin.site.index_title = "BusinessModuleApp Admin"

# swagger
api_info = openapi.Info(
    title="BusinessModuleApp API",
    default_version="v1",
    description="API documentation for BusinessModuleApp App",
)
